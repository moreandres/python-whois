...
class WhoisEntry(dict):
    ...
    _regex = {
        ...
        'name_servers': r'^Name\s+Server:[ \t]+(\S+)\s*\S*\s*\S*$',  # list of name servers
...
class WhoisTm(WhoisEntry):
    """Whois parser for .tm domains"""
...
class WhoisLv(WhoisEntry):
    ...
    regex = {
        'domain_name': r'Domain: +(.+)',
        'name_servers': r'^Nserver:\s+([a-z0-9]\S+)$',
    }
...
class WhoisRo(WhoisEntry):
    ...
    regex = {
        ...
        'creation_date': r'Registered On: *(.+)',
        'expiration_date': r'Expires On: *(.+)',
        'name_servers': r'^\s\sNameserver:\s(\S+)$',  # list of name servers
        'status': r'Status: *(.+)',  # list of statuses
        'dnssec': r'DNSSEC: *(.+)',
        'emails': EMAIL_REGEX  # list of email addresses
    }
...
class WhoisKr(WhoisEntry):
    ...
    regex = {
        ...
        'name_servers': r'^\s+Host\s+Name\s+:\s+(\S+)$',  # list of name servers
        'emails': EMAIL_REGEX  # list of email addresses
    }
...
class WhoisID(WhoisEntry):
    ...
    regex = {
        ...
        'name_servers': r'^Name\s+Server:\s+(\S+)\s*\S*$',  # list of name servers
    }
...
class WhoisSa(WhoisEntry):
    ...
    regex = {
        ...
        'creation_date': r'Created on: *(.+)',
        'updated_date': r'Last Updated on: *(.+)',
        'name_servers': r'^([a-z0-9]+\.[a-z0-9-.]+).*$',  # servers in one string sep by \n
...
class WhoisMx(WhoisEntry):
    ...
    regex = {
        ...
        'name_servers': r'^[ ]+DNS:[ ]+([a-zA-Z0-9.-]+)\*?\s*\S*$',
...
class WhoisSi(WhoisEntry):
    ...
    regex = {
        'domain_name': r'domain: *(.+)',
        'registrar': r'registrar: *(.+)',
        'name_servers': r'^nameserver:[ \t]+(\S+)\s*\S*$',
        'registrant_name': r'registrant: *(.+)',
        'creation_date': r'created: *(.+)',
        'expiration_date': r'expire: *(.+)',
    }
